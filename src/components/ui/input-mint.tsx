...
export interface InputMintProps extends React.InputHTMLAttributes<HTMLInputElement> {
  fullWidth?: boolean
  error?: boolean
...
export const InputMint = forwardRefWithAs<"input", InputMintProps>((props, ref) => {
  const {
    wrapperClassName,
    startDecorator,
