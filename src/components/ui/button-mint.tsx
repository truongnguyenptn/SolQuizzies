...
import { forwardRefWithAs } from "@/lib/render"

export const buttonMintVariants = tv({
  base: [
...
export interface ButtonMintProps
  extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "color">,
    VariantProps<typeof buttonMintVariants> {
  startDecorator?: React.ReactNode
  endDecorator?: React.ReactNode
  loading?: boolean
}

export const ButtonMint = forwardRefWithAs<"button", ButtonMintProps>(
  (
    {
      as: Tag = "button",
      className,
    ...
    return (
      <Tag
        className={cn(buttonMintVariants({ variant, color, size, fullWidth, disabled, className }))}
        ref={ref}
        disabled={disabled}
        {...props}
      >
